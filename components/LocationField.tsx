    ...
    return (
      <div className="relative group animate-in fade-in slide-in-from-top-2 duration-300">
        <input
          ...
          className="w-full h-14 px-6 rounded-2xl bg-white border border-slate-300 focus:border-primary focus:ring-4 focus:ring-primary/10 outline-none font-semibold text-sm text-slate-800 transition-all duration-300 pr-28 placeholder:text-slate-300/70 placeholder:font-normal uppercase"
        />
        <button
          type="button"
