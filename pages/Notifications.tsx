    ...
    switch (filter) {
      ...
      case 'actions':
        return notifications.filter(n => 
          (n.type === 'event_invite' || n.type === 'event_participation_request' || n.type === 'service_request' || n.type === 'almc_item_request') && 
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                {notification.invite_status === 'pending' && (
                  <div className="flex items-center gap-2 mt-4">
                    <button
                      ...
                      onClick={() => onHandleAction(notification, notification.type === 'almc_item_request' ? 'approved' : 'accepted')}
                    ...
                    >
                      ...
                      {notification.type === 'almc_item_request' ? 'Aprovar' : 'Aceitar'}
                    </button>
                    <button
                      disabled={processingId === notification.id}
                ...
                <div className="flex items-center gap-4 mt-4 pt-3 border-t border-slate-50 opacity-0 group-hover:opacity-100 transition-opacity">
                  ...
                  {notification.event && (
                    <button
                      onClick={() => navigate(`/calendar?eventId=${notification.event}`)}
