...
const UNIDADES = [
  ...
  'CAPSI II MAFALDA', 'SMS POLICLÍNICA LINCOLN DE FREITAS FILHO'
];

const CATEGORIAS_PROFISSIONAIS = [
  'ADMINISTRATIVO(A)', 'AGENTE COMUNITÁRIO DE SAÚDE (ACS)',
  'AGENTE DE VIGILÂNCIA SANITÁRIA (AVS)', 'AGENTE TERRITORIAL',
  'ASSISTENTE SOCIAL', 'AUXILIAR DE SAÚDE BUCAL',
  'AUXILIAR DE SERVIÇOS GERAIS', 'CONTROLADOR DE ACESSO',
  'CUIDADOR EM SAÚDE', 'DENTISTA', 'DIRETOR',
