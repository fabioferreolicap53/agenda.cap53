                ...
                <div className="flex flex-col gap-8 animate-in fade-in slide-in-from-bottom-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="bg-white p-6 rounded-3xl border border-slate-300 shadow-sm flex items-center gap-5 group hover:border-slate-400 transition-all">
                            <div className="size-14 rounded-2xl bg-primary text-white flex items-center justify-center shadow-lg shadow-primary/20 group-hover:scale-105 transition-transform">
                                <span className="material-symbols-outlined text-3xl">inventory_2</span>
                            </div>
                            <div>
                                <p className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-500">Total em Estoque</p>
                    ...
                    <div className="flex flex-col xl:flex-row gap-8 items-start">
                            ...
                            <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-300 shadow-xl shadow-slate-200/50">
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest mt-0.5">Cadastro de Item</p>
                                    </div>
                                </div>

                                <form onSubmit={handleAddItem} className="space-y-6">
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Nome do Item</label>
                                        <input
                                            type="text"
                                            value={newItemName}
                        ...
                        <div className="flex-1 w-full min-w-0 flex flex-col gap-6">
                            {/* Search and Filters */}
                            <div className="flex flex-col md:flex-row gap-4 items-center bg-white p-3 rounded-3xl border border-slate-300 shadow-sm">
                                <div className="relative flex-1 w-full">
                                    ...
                                    <input 
                                        ...
                                        className="w-full pl-12 pr-4 h-12 bg-slate-100/50 border border-slate-200 rounded-2xl text-sm font-bold focus:ring-4 focus:ring-slate-900/5 focus:border-slate-400 transition-all outline-none placeholder:text-slate-500"
                                    />
                                </div>
                                
                                <div className="flex items-center gap-1 p-1 bg-slate-100 rounded-2xl border border-slate-200 w-full md:w-auto">
